...
<div class="container-fluid my-5" style="padding-left: 100px; padding-right: 100px;">
  <div class="row">
    <div class="col-xl-6 col-lg-6 col-md-10 col-sm-11 col-11 mx-auto p-3">
      <div class="border">
        <div class="m-3">
          <div class="row mx-3">
            <div class="col-8">
              <h3>Tesla Model S</h3>
              <h4>Standart Range Plust Rear-Wheel Drive</h4>
            </div>
            <div class="col-4 text-right">
              <span class="text-right"><h3>39,499 $</h3></span>
              19,000 miles
            </div>
          </div>
        </div>
        <img class="img img-fluid" src="/public/media/img/swap/tesla_s_small.jpg" alt="">
        <div class="bg-light">
          <div class="mx-5">
            <div class="row py-3">
              <div class="col-6">
                <div class="my-3">
                  <h5>5.3 sec</h5>
                  <span class="text-secondary">0-60 mph</span>
                </div>
                <div class="my-3">
                  <h5>140 mph</h5>
                  <span class="text-secondary">Top speed</span>
                </div>
                <div class="my-3">
                  <h5>240 mi</h5>
                  <span class="text-secondary">Range (EPA)</span>
                </div>
              </div>
              <div class="col-6">
                <h5>Featured Options</h5>
                <ul class="text-secondary">
                  <li>Standart Range Plus Rear-Wheel Drive</li>
